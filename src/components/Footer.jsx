    ...
    <footer>
      <ul className="footer">
        ...
        <li className="resume" onClick={() => sendGA("Resume")}>
          <a
            href="https://docs.google.com/document/d/1pvHS1YcbPCQIDAkxETqj66DPt-LNGJeTtnBEIQ1c5Kw/edit?usp=sharing"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
              ...
              enableBackground="new 0 0 297.384 297.384"
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
            >
        ...
        <li className="github" onClick={() => sendGA("GitHub")}>
          <a
            href="https://github.com/paigevogie"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg

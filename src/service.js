...
export const getLinkedInData = async () => {
  /* 
    ...
    Using workaround below which has a hardcoded response instead of including this script https://platform.linkedin.com/badges/js/profile.js which then fetches the badge html
  */
